...
namespace MySQL
{
    ...
    public class DataContext : EmptyInterceptor, IDisposable
    {
        ...
        /// <summary>
        /// Load нужно использовать только для обновления уже существующего объекта предметной области (когда требуется перчитать данные из БД в моменте). 
